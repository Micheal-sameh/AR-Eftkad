...
return [
    ...
    'avarewase no matching account' => 'حساب أفارويس الخاص بك لا يحمل رقم عضوية، لذلك تعذر إنشاء حساب على إفتقاد تلقائياً. برجاء التواصل مع الإدارة.',
    'avarewase login failed' => 'فشل تسجيل الدخول عبر أفارويس. برجاء المحاولة مرة أخرى.',
    'avarewase sso unavailable' => 'خادم تسجيل الدخول لأفارويس غير متاح حالياً. برجاء المحاولة بعد قليل.',
