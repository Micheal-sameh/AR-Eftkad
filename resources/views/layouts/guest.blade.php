...
<div class="absolute top-0 right-0 w-96 h-96 bg-primary-fixed opacity-20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
<div class="absolute bottom-0 left-0 w-96 h-96 bg-tertiary-fixed opacity-20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none"></div>
...
<footer class="p-container-margin text-center z-10 relative">
    <p class="font-label-sm text-label-sm text-outline">© {{ date('Y') }} نظام إفتقاد للخدمة الرعوية</p>
</footer>
